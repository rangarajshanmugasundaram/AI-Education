  ...
  return (
    <header style={styles.header}>
      ...
      <div style={styles.headerLeftHub}>
        {/* Only visible on mobile per index.css */}
        <button 
        ...
        <div style={styles.headerTitleBox}>
          ...
          {/* Only visible on desktop per index.css */}
        ...
        <div className="desktop-only" style={styles.utilityGroup}>
          <button style={styles.headerUtilityBtn} aria-label="Notifications">
            <div style={styles.badgeWrapper}>
              <span style={styles.utilityIcon} aria-hidden="true">🔔</span>
              <span style={styles.badgeDot}></span>
            </div>
          </button>
          <button style={styles.headerUtilityBtn} aria-label="Messages">
            <span style={styles.utilityIcon} aria-hidden="true">✉️</span>
          </button>
        </div>
        
        <div style={styles.avatarWrapper}>
          <div style={styles.headerUserBadge}>RS</div>
          <span style={styles.onlineIndicator} aria-label="User is online"></span>
        </div>
      </div>
    </header>
  );
...
const styles = {
  ...
  headerMenuTrigger: {
    ...
    width: '40px',
    height: '40px',
    display: 'none', // Overridden by mobile-only class
    alignItems: 'center',
