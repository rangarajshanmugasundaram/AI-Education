...
export default function AssignTrainerModal({
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs z-50 flex items-center justify-center p-4">
      ...
      >
        <div>
          <h2 className="text-base font-bold text-slate-900">Assign Trainer</h2>
          <p className="text-xs text-slate-500 mt-1">Course: <strong className="text-slate-800">{courseTitle}</strong></p>
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-2 border border-slate-200 rounded text-xs bg-white focus:outline-none focus:border-slate-400"
          >
